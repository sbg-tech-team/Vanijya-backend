...
class ConversationMember(Base):
    ...
    # Delivery high-water mark — every message in this conversation sent at or before
    # this timestamp has reached this member's device. Drives the grey (delivered) tick.
