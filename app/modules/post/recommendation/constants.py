...
# ---------------------------------------------------------------------------
from app.modules.post.recommendation.session_taste.constants import (   # noqa: F401
    CATEGORY_NAMES,
    COMMODITY_ID_TO_IDX,
    ROLE_ID_TO_IDX,
...
# ---------------------------------------------------------------------------
# Role display names (DB id → label)
# DB seed: 1=Trader  2=Broker  3=Exporter
# ---------------------------------------------------------------------------
_ROLE_NAMES: dict[int, str] = {1: "Trader", 2: "Broker", 3: "Exporter"}
