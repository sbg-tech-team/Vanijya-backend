...
from app.modules.connections.recommendation.weights_config import (
    ALL_COMMODITIES,
    COMMODITY_BOOST,
    GEO_BOOST,
    ROLE_BOOST,
...
from app.modules.connections.recommendation.vectors import encode_commodity, encode_geo
from app.shared.utils.vector_math import weighted_cosine_similarity as _weighted_cosine_similarity
...
def cosine_similarity(a: list[float], b: list[float]) -> float:
    ...
    return _weighted_cosine_similarity(a, b)
