...
def submit_interaction_batch(
    ...
    """
    result = service.process_interaction_batch(db, profile_id, payload.events, rc)
...
def toggle_like(
    ...
    is_liked = service.toggle_like(db, profile_id, article_id, rc)
...
def toggle_save(
    ...
    is_saved = service.toggle_save(db, profile_id, article_id, rc)
...
def record_share(
    ...
    """
    service.record_share(db, profile_id, article_id, platform, rc)
...
async def send_news_article(
    ...
    try:
        result = service.send_article(db, article_id, user_id, profile_id, payload, rc)
